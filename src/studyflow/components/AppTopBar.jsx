...
import { fadeInUpAnim } from '../constants';
                ...
                <Stack component="header" direction="row" alignItems="center" justifyContent="space-between"
                    ...
                    <Stack direction="row" alignItems="center" gap={2}>
                        <Stack direction="row" alignItems="center" gap={1.5}>
                            ...
                            <Typography sx={{ fontSize: 18, fontFamily: '"Clash Display", sans-serif', fontWeight: 700, background: `linear-gradient(90deg, ${COLORS.accent}, ${COLORS.blue}, ${COLORS.accent})`, backgroundSize: '200% auto', backgroundClip: 'text', WebkitBackgroundClip: 'text', color: 'transparent', animation: 'shimmer 3s linear infinite', '@keyframes shimmer': { '0%': { backgroundPosition: '0% center' }, '100%': { backgroundPosition: '200% center' } }, display: { xs: 'none', sm: 'block' } }}>
                                StudyFlow
                            </Typography>
                        </Stack>
                    </Stack>
                    ...
                    <Box sx={{ position: 'relative', display: { xs: 'none', md: 'flex' }, alignItems: 'center', justifyContent: 'center', flex: 1, maxWidth: 'xl', mx: { xs: 1.5, sm: 3 } }}>
                        ...
                        {searchFocused && (
                            <Paper elevation={8} sx={{ position: 'absolute', top: 44, width: '100%', maxWidth: 560, borderRadius: 3, overflow: 'hidden', zIndex: 101, animation: `${fadeInUpAnim} 0.3s ease-out forwards`, background: COLORS.bgSecondary, border: `1px solid ${COLORS.border}` }}>
