...
import { Target, Play, FileText, Layers, CheckSquare, ArrowRight, Flame, Lightbulb, Frown, Smile } from 'lucide-react';
                                ...
                                <Stack sx={{ position: 'relative', zIndex: 10, gap: '12px', maxWidth: 'xl' }}>
                                    <FadeUp delay={50}>
                                        <Typography variant="h1" sx={{
                                            ...
                                            <Typography component="span" sx={{ background: `linear-gradient(to right, ${COLORS.accent}, ${COLORS.blue})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Dnes jsi v ráži.</Typography>
                                        </Typography>
                                    </FadeUp>
                                    <FadeUp delay={100}>
                            ...
                            <Box component="section" sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: 'repeat(3, 1fr)' }, gap: { xs: 2, sm: '20px' } }}>
                                ...
                                <FadeUp delay={80} sx={{
                                    ...
                                    <Stack direction="row" sx={{
                                        ...
                                        <Typography sx={{ fontSize: '0.75rem', color: COLORS.textSecondary }}>Zbývá <Typography component="strong" sx={{ color: 'white' }}>{TOTAL_DAILY - currentDone}</Typography></Typography>
                                ...
                                <FadeUp delay={140} sx={{
                                    ...
                                    <Stack direction="row" sx={{ justifyContent: 'space-between', alignItems: 'flex-start', mb: 1.5, gap: 1, minWidth: 0 }}>
                                        <Box sx={{ minWidth: 0 }}>
                                            ...
                                            <Typography sx={{ fontSize: '1.875rem', fontFamily: 'monospace', fontWeight: 700, color: 'white', lineHeight: 1 }}>32 <Typography component="span" sx={{ fontSize: '1rem', color: COLORS.textSecondary, fontFamily: '"DM Sans", sans-serif', fontWeight: 500 }}>dní</Typography></Typography>
                                        </Box>
                                        ...
                                        <Box sx={{ transition: 'transform 0.6s', transformStyle: 'preserve-3d', position: 'relative', width: '100%', height: '100%', transform: tipFlipped ? 'rotateY(180deg)' : 'none' }}>
                                            <Stack sx={{
                                                ...
                                                <Typography sx={{
                                                    ...
                                                    background: tipStatus === 'success' ? `${COLORS.green}1a` : tipStatus === 'fail' ? `${COLORS.red}1a` : COLORS.glassBgLight,
                                            ...
                                            <Stack sx={{
                                                ...
                                                <Stack direction="row" sx={{ gap: 1, mt: 1.5 }}>
                                                    <Button sx={{
                                                        ...
                                                        background: `${COLORS.red}1a`, color: COLORS.red, border: `1px solid ${COLORS.red}33`,
                                                    }}
                                                        onClick={(e) => {
                                                            e.stopPropagation();
                                                            setTipStatus('fail');
                                                    ...
                                                    <Button sx={{
                                                        ...
                                                        display: 'flex', gap: 0.5, justifyContent: 'center', alignItems: 'center',
                                                        transition: 'all 0.2s', '&:hover': { transform: 'scale(1.03)' }, '&:active': { transform: 'scale(0.97)' },
                                                        background: `${COLORS.green}1a`, color: COLORS.green, border: `1px solid ${COLORS.green}33`,
                                                    }}
                                                        onClick={(e) => {
                                                            e.stopPropagation();
